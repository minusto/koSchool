...
public interface MockSimulationService {
	...
	public HopeUniversityVO selectExistHopeUniversityService(String memberId) throws Exception; //액터 ==> 학생, 학부모, 교사 / 작업 내용 : 학생의 아이디로 입력되어있는 목표 대학을 반환 / 작성자 : 구혜인
	...
	public HopeUniversityVO insertHopeUniversityService(Map<String, String> map) throws Exception; //액터 ==> 학생 / 작업 내용 : 학생이 선택한 목표 대학 학과를 가지고 EntranceInfo에서 조회하여 HopeUniversity에 입력 / 작성자 : 구혜인
	...
	public MockSimulationDTO hopeUniversityPrintService(HopeUniversityVO hopeUniversityVo) throws Exception; //액터 ==> 학생, 학부모, 교사 / 작업 내용 : 목표대학에 대한 부분을 출력하기 위한 데이터를 가져간다 / 작성자 : 구혜인
