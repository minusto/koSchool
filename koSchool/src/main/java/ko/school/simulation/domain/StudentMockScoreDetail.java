...
public class StudentMockScoreDetail {
	//학생 가장 최근 모의고사 점수
	...
	public String getKoreaHistoryId() {
		return koreaHistoryId;
	}
	public void setKoreaHistoryId(String koreaHistoryId) {
		this.koreaHistoryId = koreaHistoryId;
	}
	public int getKoreaHistoryOriginalScore() {
		return koreaHistoryOriginalScore;
	}
