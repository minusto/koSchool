...
public class LoginController {
	...
	// 액터 ==> 학생 / 작업내용 : 메인페이지 접근시 인터셉터 prehandle 메소드에 의해 액터에 맞는 메인으로 보내줌 / 작성자
	// : 이재승
	...
	// 액터 ==> 교사 / 작업내용 : 메인페이지 접근시 인터셉터 prehandle 메소드에 의해 액터에 맞는 메인으로 보내줌 / 작성자
	// : 이재승
	...
	// 액터 ==> 학부모 / 작업내용 : 메인페이지 접근시 인터셉터 prehandle 메소드에 의해 액터에 맞는 메인으로 보내줌 /
	// 작성자 : 이재승
	...
	// 액터 ==> 학교관리자 / 작업내용 : 메인페이지 접근시 인터셉터 prehandle 메소드에 의해 액터에 맞는 메인으로 보내줌 /
	// 작성자 : 이재승
	...
	// 액터 ==> 시스템관리자 / 작업내용 : 메인페이지 접근시 인터셉터 prehandle 메소드에 의해 액터에 맞는 메인으로 보내줌 /
	// 작성자 : 이재승
