...
<script>
	$(function() {
		$('#updateButton').click(function() {
			location.href="/updateNoticeBoardForm?noticeBoardNum=${noticeBoardDetail.noticeBoardNum }";
		})
		
		$('#deleteOk').click(function(){
			location.href="/deleteNoticeBoard?noticeBoardNum=${noticeBoardDetail.noticeBoardNum }";
		})
	});
</script>
</head>
							...
							<div class="card">
								...
								<div class="card-body table-responsive col-lg-8">
									...
									<table class="table table-bordered">
										<tr height="30">
											<th width="150">글번호</th>
											<td width="150">${noticeBoardDetail.noticeBoardNum}</td>
											<th width="150">조회수</th>
											<td width="150">${noticeBoardDetail.noticeBoardHitcount}</td>
										</tr>
										<tr height="30">
											<th width="150">작성자</th>
											<td width="150">${noticeBoardDetail.schoolAdminId }</td>
											<th width="150">작성일</th>
											<td width="150"><fmt:formatDate
													value="${noticeBoardDetail.noticeBoardDate}" pattern="yyyy-MM-dd" /></td>
										</tr>
										<tr height="30">
											<th width="150">제목</th>
											<td colspan="3">${noticeBoardDetail.noticeBoardTitle }</td>
										</tr>
										<tr height="30">
											<th width="150">파일</th>
											<td colspan="3"><a
												href="/DownloadView?fileName=${noticeBoardDetail.noticeBoardFileName}">${noticeBoardDetail.noticeBoardFileName}</a>
											</td>
										</tr>
										<tr height="150">
											<td colspan="4">${noticeBoardDetail.noticeBoardContent}</td>
										</tr>
									</table>
									<a href="/noticeBoardList"><button class="btn btn-primary">목록보기</button></a>
